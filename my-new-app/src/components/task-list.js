...
import styles from "./cssfiles/tasklist.module.css";
  ...
  return (
      ...
      <ul>
        {tasks.map((task) => (
          ...
          <li className={styles.TaskCardli} key={task.id}>
            <label className={styles.CheckboxWrapper}>
            < input className={styles.HiddenCheckbox}
            type= "checkbox"
        ...
        />
            ...
            <p id={styles.TaskName} className={task.completed ? "done" : ""}>
{task.name}
</p>
